...
import { openLeadProfileModel, getDocByType, groupEmailSearch, getAddressProofDoc, getGroupList, getLenderLeadDetails, getBankDocuemnt, clearEmailSearch, getLeadProfile, geBbureau, getAddress, getLeadOtherDocuemnt, getLeadPanDocuemnt, getLeadProfileDocuemnt, getAddressProof, getDocumentCount, getRepayment, geBbureauHardpull, sendEmailCAM } from "../actions/users";
import {
  CircularProgressbar,
...
class LeadDetails extends Component {
  ...
  componentDidMount() {
    ...
    let datar = {
      opp_sfid: lead_id
      // THIS NOW TEMRPY USE STATIC OPP_ID BELOW
      // opp_sfid: "00671000001VQDmAAO"
    }
    ...
    this.props.dispatch(getLenderLeadDetails(opp_data)).then((response) => {
      if (response.status === "success") {
        ...
        this.setState({
          ...
          lendername: getData && getData.lender_name ? getData.lender_name : '-',
          disbarsalAmt: getData && getData.disbursal_amount ? getData.disbursal_amount : '0',
          disbarsalDate: getData && getData.disbursal_date ? getData.disbursal_date : '-',
          utrdisburment: getData && getData.utr ? getData.utr : '-',
          ...
          approvedBy: getData && getData.approvedBy ? getData.approvedBy : '-',
          disbursedBy: getData && getData.disbursedBy ? getData.disbursedBy : '-',
          approveDate: getData && getData.approval_date ? getData.approval_date : '',
          title_satge: getData && getData.stage ? getData.stage : 'N/A',
          disbursalDate: getData && getData.disbursal_date ? getData.disbursal_date : '',
        })
        this.getLeadProfile(getData.sfid);
      }
    });
    // this.props.dispatch(getStatusmsg(opp_data)).then((response) => {

    //   let getData1 = response.data.pendingApprovedMatrix;
    //   let getData2 = response.data.disbursedApprovedMatrix;
    //   console.log('qqqq', response)
    //   if (response.status === "success") {
    //     this.setState({

    //       aprrove: getData1 && getData1.approved_by ? getData1.approved_by : '-',
    //       aprrovedate: getData1 && getData1.approved_on ? getData1.approved_on : '-',
    //       approvedis: getData2 && getData2.approved_by ? getData2.approved_by : '-',
    //       approvedatedis: getData2 && getData2.approved_on ? getData2.approved_on : '-',
  ...
  render() {
    ...
    const { bank_data, alldoccount, datarrr, bureaurs, harddata, bureaurData, currentAddress } = this.state;
    console.log(this.state.selectedAddress);
    //console.log( 'vvvvv',this.state.statusdisbursed)
    if (!user_id) {
      return <Redirect to="/login" />
    }

    let date = this.state.approveDate ? this.state.approveDate.slice(0, 10).split('-') : '-';
    let formated_date = this.state.approveDate ? `${date[0]} ${Month[Number(date[1]) - 1]} ${date[2]} ${this.state.approveDate.slice(11)}` : '-';
    let date1 = this.state.disbursalDate ? this.state.disbursalDate.slice(0, 10).split('-') : '-';
    let formated_date1 = this.state.disbursalDate ? `${date1[0]} ${Month[Number(date1[1]) - 1]} ${date1[2]} ${this.state.disbursalDate.slice(11)}` : '-';
            ...
            <div className="container-fluid lead_details_header">
              <div className="row align-items-center">
                <div className="d-flex">
                  <div style={{ flex: '1' }}>
                    <div className="backicon float-left"><a href="/disbursed"> <img src="img/icon_back.svg" /></a></div>

                    {/* <a href="/disbursed"><div className="backicon float-left"><img src="img/icon_back.svg" /></div></a> */}
                    <div className="d-flex">
                      ...
                      <div className="pr_texts">
                        <h5 className="d-block">{this.state.sfid} <span><b>Disbursed</b></span></h5>
                  ...
                  {/* <form action="" className="search-form nav_search">
                    <div className="form-group has-feedback">
                      <label htmlFor="search" className="sr-only w-100">Search</label>
                                    ...
                                    <div class="panel panel-default">
                                      ...
                                      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                          <ol>
                                            {ele && ele.email && ele.email.length > 0 && ele.email.map(obj => { return (<li>{obj && obj.email}</li>) })}
                                          </ol>
                                        </div>
                                      </div>
                                    </div>
                ...
                <div className="col-md-12">
                  <div className="row mt-3 align-items-center">
                    ...
                    <div className="col-md-6 text-right tbuttons">
                      <button className="btn btn-primary csy1 mr-4"><img src="img/icon_tick.svg" /><b> Approved by: {this.state.approvedBy}<span className="d-block">On {formated_date}</span></b>
                      </button>
                      <button className="btn btn-primary csy1"><img src="img/icon_tick.svg" /><b> Disbursed by: {this.state.disbursedBy}<span className="d-block">On {formated_date1}</span></b>
                      </button>
                    </div>
                  </div>
                          ...
                          >
                            <div className="row">
                              <div className="col-md-3">
                                <div className="whiteboxed">
                                  ...
                                  <h4><b> {this.state.firstname ? this.state.firstname : 'N/A'} {this.state.lastname ? this.state.lastname : 'N/A'}</b></h4>
                                  <div className="personinfo">{this.state.gender ? this.state.gender : 'N/A'} <span className="dob"> {dateFormat(this.state.dob, "dd-mmm-yy")}</span><span className="maritalstatus">{this.state.martialstatus ? this.state.martialstatus : 'N/A'}</span></div>
                                  ...
                                  <div className="personinfo">{this.state.occupation ? this.state.occupation : 'N/A'} <span className="profession"> {this.state.sector ? this.state.sector : 'N/A'}</span><span className="companydetails">{this.state.company_name ? this.state.company_name : 'N/A'}</span></div>
                            ...
                            <div className="row mt-5">
                              <div className="whiteboxed">
                                ...
                                <h4><b>Disbursement Details</b> <img src="img/icon_iicon.svg" /></h4>
                                <h6><span>Lender Name :</span> <b>{this.state.lendername}</b></h6>
                                <div class="col-md-12" >
                                  <table class="table">
                                    <thead>
                                      <tr>
                                        <th scope="col"> <img src="images/percent_sale_icon.svg" /></th>
                                        <th scope="col"><h6>Disbursement Date</h6></th>
                                        <th scope="col"> <img src="images/money-bag-copy.svg" /></th>
                                        <th scope="col"><h6>Amount</h6></th>
                                        <th scope="col"> <img src="images/cross.svg" /></th>
                                        <th scope="col"><h6>UTR No.</h6></th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      <tr>
                                        <th scope="row"></th>
                                        <td> <span><b>{this.state.disbarsalDate ? this.state.disbarsalDate : '-'}</b></span></td>
                                        <th scope="row"></th>
                                        <td> <a href="#"><b>₹{this.state.disbarsalAmt ? this.state.disbarsalAmt : '-'}</b></a></td>
                                        <th scope="row"></th>
                                        <td>  <a href="#" style={{ color: 'black' }}><b>{this.state.utrdisburment ? this.state.utrdisburment : 'N/A'}</b></a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  {/* <ul>
                                    <li>
                                      <img src="images/percent_sale_icon.svg" />
                                      Disbursement Date
                                      <span><b>{this.state.disbarsalDate}</b></span>
                                    </li>
                                    <li>
                                    <img src="images/money-bag-copy.svg" />
                                     Amount
                                      <a href="#"><b>₹{this.state.disbarsalAmt}</b></a>
                                    </li>
                                    <li >
                                    <img src="images/cross.svg" />
                                     UTR No.
                                      <a href="#" style={{color:'black'}}><b>{this.state.utrdisburment}</b></a>
                                    </li>
                                  </ul> */}
                                </div>
                              </div>
                                  ...
                                  <ul className="nav nav-tabs" id="verticaltab" role="tablist">
                                    <li className="nav-item">
                                      ...
                                      >
                                        ...
                                        Loan Documents ({this.state.alldoccount.loanDocCount ? this.state.alldoccount.loanDocCount : '0'}) <img src="images/download.svg" />
                                      </a>
                                    </li>
                                    <li className="nav-item">
                                      <a
                                ...
                                <div className="col-md-9">
                                  <div className="tab-content">
                                    <div className="tab-pane active" id="loandocuments" role="tabpanel">
                                      <h3 className="mb-3"><b>Loan Documents</b></h3>
                                      <div className="row">
                                        <div className="col-md-12 isdownload">
                                          <h6><b>Loan Agreement </b><img src="images/download.svg" /></h6>
                                      ...
                                      <div className="row">
                                        <div className="col-md-12 isdownload">
                                          <h6><b>Physical Nach</b> <img src="images/download.svg" /></h6>
                                          <div className="docimgs">
                                    ...
                                    datarrr && datarrr.length > 0 ?
                                      ...
                                      datarrr.map((item, index) => (
                                        ...
                                        >
                                          ...
                                          <td>{item.emi_amount ? item.emi_amount : '0'}</td>
                                          <td>{item.paid_principal__c ? item.paid_principal__c : '0'}</td>
                                          <td>{item.paid_interest__c ? item.paid_interest__c : '0'}</td>
                                          <td className="bold">₹ {item.paid_discount__c ? item.paid_discount__c : '0'}</td>
                                          ...
                                          <td className="payment"><img src="images/e-nach.svg" /> {item.repayment_mode__c ? item.repayment_mode__c : '0'}</td>
