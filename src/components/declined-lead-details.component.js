...
import { openLeadProfileModel, getDocByType, getGroupList, getBankDocuemnt, getLenderLeadDetails, groupEmailSearch, clearEmailSearch, getAddressProofDoc, getLeadProfile, getAddressProof, getAddress, getLeadOtherDocuemnt, getLeadPanDocuemnt, getLeadProfileDocuemnt, getDocumentCount, geBbureau, geBbureauHardpull, getRepayment, sendEmailCAM } from "../actions/users";
import {
  CircularProgressbar,
...
const NODOC = "NODOC"
const FAIL = "FAIL"
class DeclinedLeadDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bankSrc: '',
  ...
  render() {
    ...
    const { bank_data, bureaurs, harddata, datarrr, bureaurData, currentAddress } = this.state
            ...
            <div className="container-fluid lead_details_header">
              <div className="row align-items-center">
                <div className="d-flex">
                  <div style={{ flex: '1' }}>
                    <div className="backicon float-left"><a href="/declined"> <img src="img/icon_back.svg" /></a></div>
                    <div className="d-flex">
                      ...
                      <div className="pr_texts">
                        <h5 className="d-block">{this.state.sfid} <span><b>Declined</b></span></h5>
                                  ...
                                  <ul className="nav nav-tabs" id="verticaltab" role="tablist">
                                    <li className="nav-item">
                                      <a
                                        ...
                                        aria-controls="kyc"
                                      >
                                        KYC Documents (05) <span onClick={this.kycDocumentsDownload}><img src="images/download.svg" /></span>
                                      </a>
                                    </li>
                                    <li className="nav-item">
                                      <a
                                    ...
                                    <li className="nav-item">
                                      ...
                                      >
                                        Financial Statements (02)<a href={void (0)} onClick={() => this.financialDocumentsDownload()} ><img src="images/download.svg" /></a>
                                      </a>
                                    </li>
                                    <li className="nav-item">
                                      <a
...
export default connect(mapStateToProps)(DeclinedLeadDetails);
