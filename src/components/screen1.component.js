...
<div id="wrapper">
  ...
  <div className="col-md-8 text-right tbuttons">
      ...
      <button className="btn btn-dark mr-4"><img src="img/icon_book_loan.svg" /> Book Loan</button>
      <button className="btn btn-primary"><img src="img/icon_drop_case.svg" /> Drop Case</button>
  </div>
    </div>
...
<div className="col-md-2">
  <div className="">Add crdit score js</div>
        ...
        <h6 className="s1">Borrower's Bureau Analysis <span>Refreshed on: 12th Dec 2021, 11AM</span></h6>
          ...
          <li>No. of Tradelines with Overdue Amount <i class="fa fa-angle-right" aria-hidden="true"></i> 0<span>8</span></li>
          ...
          <li>No. of Tradelines with Overdue Amount <i class="fa fa-angle-right" aria-hidden="true"></i> 5000 <span>0</span></li>
