...
import { openLeadProfileModel, getAddressProofDoc, getDocByType, getGroupList, getBankDocuemnt, getAddressProof, groupEmailSearch, clearEmailSearch, getLenderLeadDetails, getLeadProfile, getAddress, getLeadOtherDocuemnt, getLeadPanDocuemnt, getLeadProfileDocuemnt, getDocumentCount, geBbureau, geBbureauHardpull, getRepayment, sendEmailCAM } from "../actions/users";
...
const NODOC = "NODOC"
const FAIL = "FAIL"
class DroppedLeadDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bankSrc: '',
            ...
            <div className="container-fluid lead_details_header">
              <div className="row align-items-center">
                <div className="d-flex">
                  <div style={{ flex: '1' }}>
                    <div className="backicon float-left"><a href="/dropped"> <img src="img/icon_back.svg" /></a></div>
                    <div className="d-flex">
                      ...
                      <div className="pr_texts">
                        <h5 className="d-block">{this.state.sfid} <span><b>Dropped</b></span></h5>
...
export default connect(mapStateToProps)(DroppedLeadDetails);
