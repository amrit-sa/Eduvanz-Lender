...
import { getLeadProfile, getDocByType, getBankDocuemnt, getGroupList, getAddress, getLeadOtherDocuemnt, getAddressProofDoc, getAddressProof, getLeadPanDocuemnt, getLeadProfileDocuemnt, getLenderLeadDetails, openLeadProfileModel, geBbureau, geBbureauHardpull, getRepayment, getDocumentCount, groupEmailSearch, clearEmailSearch, sendEmailCAM } from "../actions/users";
import {
  CircularProgressbar,
...
class LeadDetails extends Component {
    ...
    this.props.dispatch(getLenderLeadDetails(opp_data)).then((response) => {
      if (response.status === "success") {
        ...
        this.setState({
          ...
          resident_type: getData && getData.resident_type__c ? getData.resident_type__c : 'NO data ',
          ...
          civil_score: getData && getData.bureau_score ? getData.bureau_score : '',
  ...
  openLeads = async (id, direction) => {
    ...
    // console.log(lead_id , all_leads_arr , next_lead)
  ...
  getLeadProfile = (user_sfid) => {
    ...
    this.props.dispatch(getAddress(data)).then((response) => {
      if (response.status === "success") {
        ...
        this.setState({
          addressList: getData,
          // Now fetching current address object from the lender_lead_details API response.
  ...
  render() {
    const { isLoggedIn, message, lead_id, lead_profile, salesForceToken, user_id, isLoading, opp_sfid, repayment } = this.props;
    const { bank_data, datarrr, bureaurs, harddata, alldoccount, bureaurData, selected, show_docType, selectedTab, addressList, currentAddress } = this.state;
            ...
            <div className="container-fluid lead_details_header">
              <div className="row align-items-center">
                <div className="d-flex">
                  <div style={{ flex: '1' }}>
                    <div className="backicon float-left"><a href="/leads"><img src="img/icon_back.svg" /></a></div>
                    <div className="d-flex">
                      <div className="pr_img" >
                        {this.state.profileBase ?
                          <img className="img-profile rounded-circle img_icon_width" src={this.state.profileBase} />
                          : <img className="img-profile rounded-circle" src="img/undraw_profile.svg" />}
                      </div>
                      <div className="pr_texts">
                        <h5 className="d-block">{this.state.sfid} <span><b>{this.state.title_satge}</b></span></h5>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="closeModal_example">
                            ...
                            <div class="modal-footer">
                              {this.state.errorMsg ? <p style={{ color: "red" }} className="ml-2 pt-1">{this.state.errorMsg}</p> : ""}
                              ...
                              <button type="button" class="emailBtn1" data-dismiss={this.state.selectGroup && this.state.selectGroup.length > 0 && this.state.selected && this.state.selected.length > 0 ? "modal" : ""}
                                onClick={e => {
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-5">
                                <div className="whiteboxed">
                                  ...
                                  <h4>
                                    {/* <b>{this.state.moratorium_type}</b> */}
                                  ...
                                  <div className="row">
                                    <div className="col-md-2">
                                      ...
                                      {/* <div className="mt-4 position-relative">
                                        <div className="clock">
                                          <div className="handel" style={this.state.civil_score ? { "transform": "rotate(" + (300 / 900) * 782 + "deg)" }
                                                ...
                                                bureaurs && bureaurs.length ? bureaurs.map((item, index) => (
                                                  <div className="row" key={item}>
                                                    ...
                                                    <div className="col-md-10" >
                                                      ...
                                                      <h5 className="s2"><b>Hard Pull Experian</b>
                                                        <a href="#" > View Report</a></h5>
                                        ...
                                        <div className="col-md-12 isdownload"   >
                                          {bureaurData && bureaurData.length > 0 &&
                                            <>
                                              ...
                                              {/* {bureaurData.map((item, index) => (
                                                <>
                                                  <h6><b>{item.base64['Document Type']}</b> <a href={void (0)} onClick={() => this.financialDocumentsDownload()} ><img src="images/download.svg" /></a></h6>
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="col-md-12 isdownload ">
                                          {this.state.statementBase && (
                                            <>
                                              <h6 href={void (0)} onClick={() => this.financialDocumentsDownload()}><b>Salary Slips</b><img src="images/download.svg" /></h6>
                                              <div className="docimgs">
...
function mapStateToProps(state) {
  const { isLoading, isLoggedIn, salesForceToken, user_id, user_sfid } = state.auth;
